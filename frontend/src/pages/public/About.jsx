...
export default function About() {
  return <>
    <Seo title="About Allay House | Beauty, Wellness & Movement" description="Allay House is a Lagos sanctuary bringing beauty treatments, spa rituals, and restorative movement into one considered experience." path="/about" image={imagePaths.about.hero} preloadImage={imagePaths.about.hero} />
